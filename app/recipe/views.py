...
@extend_schema_view(  # Decorator that allow to extend the auto generated scheme that's created by Django rest spectacular
...
class RecipeViewSet(viewsets.ModelViewSet):
    ...
    def _params_to_int(self, qs):
        """Convert a list of strings to list of intergers"""
    ...
    list=extend_schema(  # Extend the schema for the list endpoint
        parameters=[
            OpenApiParameter(
                ...
                description='Filter by items assiged to recipes.'
            ),
        ]
    )
)
